...
void display_start_screen(){
    std::cout << "Passmate: Your simple password manager" << "\n";
    std::cout << "  (1) Create an account" << "\n";
    std::cout << "  (2) Sign-in to an existing account" << "\n";
    std::cout << "  (3) Exit program" << "\n";
    std::cout << "  Input number: ";
}
/*Prints options at home screen*/
void display_home_screen(const std::string &signed_in_user_name){
    std::cout << "Passmate: Your simple password manager - Welcome " << signed_in_user_name << "\n";
    std::cout << "  (1) Look-Up a Credential" << "\n";
    std::cout << "  (2) Add a new credential item" << "\n";
    std::cout << "  (3) Browse credentials" << "\n";
    std::cout << "  (4) Sign-out of current session" << "\n";
    std::cout << "  Input number: ";
}

std::pair <std::string, std::string> display_sign_in_screen(){
    std::pair<std::string, std::string> login_string;
    std::cout << "Sign-in to your Passmate account" << "\n";
